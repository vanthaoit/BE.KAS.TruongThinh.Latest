...
import { getColor } from 'utils/constants/colors';
import { randomNum } from 'utils/tools/randumNum';
      ...
      <Row>
        <Col xl={6} lg={12} md={12}>
          <Card>
            ...
            <CardBody>{/* <Bar data={genLineData()} /> */}</CardBody>
          </Card>
        </Col>
      ...
      <Row>
        <Col xl={6} lg={12} md={12}>
          <Card>
            ...
            <CardBody>{/* <Pie data={genPieData()} /> */}</CardBody>
          </Card>
        </Col>
        ...
        <Col xl={6} lg={12} md={12}>
          <Card>
            ...
            <CardBody>{/* <Doughnut data={genPieData()} /> */}</CardBody>
          </Card>
        </Col>
      </Row>
      ...
      <Row>
        <Col xl={6} lg={12} md={12}>
          <Card>
            ...
            <CardBody>{/* <Polar data={genPieData()} /> */}</CardBody>
          </Card>
        </Col>
        ...
        <Col xl={6} lg={12} md={12}>
          <Card>
            ...
            <CardBody>{/* <Radar data={genLineData()} /> */}</CardBody>
          </Card>
        </Col>
      </Row>
    </Page>
